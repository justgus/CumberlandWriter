...
- **DR-verified-XXXX-YYYY.md** - Resolved and verified issues in batches of 10
...
These DRs were closed without verification (external limitations, design changes, superseded by other work).
...
See: [DR-archive-0038-0056.md](./DR-archive-0038-0056.md) for deferred/OBE DRs:
