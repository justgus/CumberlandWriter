...
class ProceduralPatternGenerator {
    ...
    static func noise(_ x: CGFloat, _ y: CGFloat, seed: Int = 0) -> CGFloat {
        let ix = Int(floor(x))
        let iy = Int(floor(y))
    ...
    static func fbm(_ x: CGFloat, _ y: CGFloat, octaves: Int = 4) -> CGFloat {
        var value: CGFloat = 0
    ...
    static func generateDetailedCoastline(
        points: [CGPoint],
        width: CGFloat,
    ...
    static func generateBeachCoastline(
        points: [CGPoint],
        width: CGFloat,
        beachWidth: CGFloat
    ...
    static func generateDetailedCliff(
        points: [CGPoint],
        width: CGFloat,
        height: CGFloat,
    ...
    static func generateNaturalRidge(
        points: [CGPoint],
        width: CGFloat,
    ...
    static func generateMountainRange(
        points: [CGPoint],
        width: CGFloat,
    ...
    static func generateMeanderingRiver(
        startPoint: CGPoint,
        endPoint: CGPoint,
        width: CGFloat,
    ...
    static func generateIrregularLake(
        center: CGPoint,
        radius: CGFloat,
