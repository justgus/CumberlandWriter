...
class ElevationMap {
    ...
    init(width: Int, height: Int, seed: Int, waterPercentage: Double = 0.5, scale: Double = 1.0, octaves: Int = 6) {
        self.width = width
        self.height = height
        self.elevations = []
    ...
    func elevation(at x: Int, y: Int) -> Double {
...
private extension Double {
    /// Clamp value to a range (private to avoid conflicts)
