...
struct ER0021_VisualElementsModelTests {
    ...
    func testHasSufficientDataWithProperties() {
        ...
        #expect(elements.hasSufficientData == true, "Character elements with visual properties should have sufficient data")
    }
    ...
    func testHasSufficientDataSparseProperties() {
        ...
        // For characters, hasSufficientData is true if ANY of physicalBuild, hair, eyes, or clothing is set
        #expect(elements.hasSufficientData == true, "Character elements with physicalBuild or hair set should have sufficient data")
    }
