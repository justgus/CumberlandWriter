...
extension BrushEngine {
    ...
    public static func generateMountainPattern(
        points: [CGPoint],
        width: CGFloat,
    ...
    public static func generateHillPattern(
        points: [CGPoint],
        width: CGFloat
    ) -> CGPath {
        let path = CGMutablePath()
    ...
    public static func generateForestPattern(
        points: [CGPoint],
        width: CGFloat,
        density: CGFloat = 1.0
    ) -> [(CGPoint, CGPath)] {
    ...
    public static func generateSingleTree(size: CGFloat) -> CGPath {
        let path = CGMutablePath()
    ...
    public static func generateBuildingPattern(
        points: [CGPoint],
        width: CGFloat,
        density: CGFloat = 1.0
    ...
    public static func generateCoastlinePattern(
        points: [CGPoint],
        width: CGFloat,
    ...
    public static func generateCliffPattern(
        points: [CGPoint],
        width: CGFloat,
    ...
    public static func generateRidgePattern(
        points: [CGPoint],
        width: CGFloat
    ) -> CGPath {
        let path = CGMutablePath()
    ...
    public static func generateWaterPattern(
        points: [CGPoint],
        width: CGFloat,
    ...
    public static func generateProceduralRiverPath(
        points: [CGPoint],
        width: CGFloat,
    ...
    public static func generateRiverPressureProfile(pointCount: Int) -> [CGFloat] {
    ...
    public static func generateRiverStrokeWithPressure(
        centerPath: [CGPoint],
        baseWidth: CGFloat,
    ...
    public static func generateRoadPattern(
        points: [CGPoint],
        width: CGFloat,
    ...
    public static func renderPatternStroke(
        pattern: CGPath,
        color: Color,
        width: CGFloat,
        context: CGContext
...
public enum BuildingStyle: CaseIterable {
    ...
    public static func randomWeighted() -> BuildingStyle {
    ...
    public func render(in rect: CGRect, context: CGContext, color: CGColor) {
