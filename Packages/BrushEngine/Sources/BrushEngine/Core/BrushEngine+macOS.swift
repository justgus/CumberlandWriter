...
extension BrushEngine {
    ...
    public struct MacOSDrawingStroke: Codable, Identifiable {
        public let id: UUID
        public var points: [CGPoint]
        public var pressurePoints: [CGFloat]? // Optional pressure data
    ...
    public static func createBezierPath(from points: [CGPoint], smoothing: CGFloat = 0.5) -> NSBezierPath {
    ...
    public static func renderStrokeForMacOS(
        brush: MapBrush,
        points: [CGPoint],
        color: Color,
        width: CGFloat? = nil,
    ...
    public static func compositeLayersForMacOS(
        layers: [DrawingLayer],
        size: CGSize,
    ...
    public static func extractPressureFromEvent(_ event: NSEvent) -> CGFloat {
    ...
    public static func renderPressureSensitiveStrokeForMacOS(
        points: [CGPoint],
        pressures: [CGFloat],
        brush: MapBrush,
        color: Color,
    ...
    public static func exportLayerToPNG(_ layer: DrawingLayer, size: CGSize) -> Data? {
        let image = NSImage(size: size)
    ...
    public static func exportCompositeToPNG(layers: [DrawingLayer], size: CGSize, backgroundColor: NSColor = .white) -> Data? {
    ...
    public static func cacheLayerRendering(_ layer: DrawingLayer, size: CGSize) -> NSImage {
        let image = NSImage(size: size)
...
// NSColor.init(_ color: Color) is provided by the platform on macOS 14+
