...
extension BrushEngine {
    ...
    public static func createAdvancedPKTool(
        from brush: MapBrush,
        color: Color,
        width: CGFloat? = nil
    ) -> PKTool {
    ...
    @MainActor
    public static func configurePKCanvasView(_ canvasView: PKCanvasView, for brush: MapBrush) {
    ...
    public static func requiresCustomRendering(_ brush: MapBrush) -> Bool {
        switch brush.patternType {
        case .solid, .stippled:
    ...
    public static func renderCustomPattern(
        brush: MapBrush,
        points: [CGPoint],
        color: Color,
        width: CGFloat,
    ...
    public static func extractPressureData(from stroke: PKStroke) -> [(CGPoint, CGFloat)] {
    ...
    public static func renderPressureSensitiveStroke(
    ...
    public static func renderPKDrawingWithCustomBrushes(
        drawing: PKDrawing,
