...
public enum BaseLayerCategory: String, Codable {
...
public enum BaseLayerFillType: String, CaseIterable, Codable, Identifiable {
    ...
    public var category: BaseLayerCategory {
        switch self {
    ...
    public static func types(for category: BaseLayerCategory) -> [BaseLayerFillType] {
        allCases.filter { $0.category == category }
    }

    /// Get exterior fill types
    public static var exteriorTypes: [BaseLayerFillType] {
        types(for: .exterior)
    }

    /// Get interior fill types
    public static var interiorTypes: [BaseLayerFillType] {
        types(for: .interior)
    }
}
...
public struct LayerFill: Codable, Equatable {
    /// The type of fill
    public var fillType: BaseLayerFillType

    /// Custom color override (if nil, uses fillType.defaultColor)
    public var customColor: LayerFillColor?

    /// Fill opacity (0.0 to 1.0)
    public var opacity: CGFloat = 1.0

    /// Seed for procedural pattern generation (ensures consistent patterns)
    public var patternSeed: Int = 12345

    /// Optional terrain metadata for procedural exterior generation
    public var terrainMetadata: TerrainMapMetadata?
    ...
    public var usesProceduralPattern: Bool {
        fillType.category == .interior
    }

    /// Whether this fill type uses procedural terrain generation (exterior types with metadata)
    public var usesProceduralTerrain: Bool {
        fillType.category == .exterior && terrainMetadata != nil
    }

    /// Initialize with a fill type
    public init(fillType: BaseLayerFillType, customColor: LayerFillColor? = nil, opacity: CGFloat = 1.0, patternSeed: Int? = nil, terrainMetadata: TerrainMapMetadata? = nil) {
    ...
    public init(fillType: BaseLayerFillType, color: Color? = nil, opacity: CGFloat = 1.0, patternSeed: Int? = nil, terrainMetadata: TerrainMapMetadata? = nil) {
        self.fillType = fillType
...
public struct LayerFillColor: Codable, Equatable {
