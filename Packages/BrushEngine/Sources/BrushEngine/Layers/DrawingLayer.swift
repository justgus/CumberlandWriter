...
@Observable
public class DrawingLayer: Identifiable, Codable {
    // MARK: - Identity

    public let id: UUID
    public var name: String
    public var order: Int // Z-index for rendering (higher = on top)
    ...
    public var opacity: CGFloat // 0.0 to 1.0
    ...
    public var macosStrokes: [DrawingStroke]

    // MARK: - Base Layer Fill

    /// Optional fill for base layers (typically order == 0)
    public var layerFill: LayerFill?
    ...
    public func applyFill(_ fill: LayerFill?) {
        self.layerFill = fill
        markModified()
    }
...
public enum MapContext: String, CaseIterable {
...
public enum LayerType: String, CaseIterable, Codable, Identifiable {
    ...
    public var applicableContexts: Set<MapContext> {
        switch self {
    ...
    public static func types(for context: MapContext) -> [LayerType] {
        if context == .all {
...
public enum LayerBlendMode: String, CaseIterable, Codable {
    case normal = "Normal"
...
public struct DrawingStroke: Codable {
    public var points: [CGPointCodable]
    public var colorRed: CGFloat
    public var colorGreen: CGFloat
    public var colorBlue: CGFloat
    public var colorAlpha: CGFloat
    public var lineWidth: CGFloat
    public var toolType: String

    // DR-0031: Store brush metadata for advanced rendering
    public var brushID: UUID?  // Optional for backward compatibility
    ...
    public var cachedImageData: Data?

    // ER-0007: Bounding box for cached image placement
    public var cachedImageOrigin: CGPointCodable?
    ...
    public init(
        ...
        cachedImageOrigin: CGPointCodable? = nil
    ) {
        self.points = points
        ...
        self.cachedImageOrigin = cachedImageOrigin
    }
}
...
extension DrawingLayer {
    ...
    public static func sample(name: String, type: LayerType) -> DrawingLayer {
