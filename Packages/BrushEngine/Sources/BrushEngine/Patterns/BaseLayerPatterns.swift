...
public protocol ProceduralPattern {
...
public class NoiseGenerator {
    ...
    public func fractalNoise2D(x: Double, y: Double, octaves: Int = 4, persistence: Double = 0.5) -> Double {
        var total = 0.0
        var frequency = 1.0
        var amplitude = 1.0
        var maxValue = 0.0
...
public struct TilePattern: ProceduralPattern {
    public init() {}
...
public struct WoodPattern: ProceduralPattern {
    public init() {}
...
public struct SlatePattern: ProceduralPattern {
    public init() {}
...
public struct StonePattern: ProceduralPattern {
    public init() {}
...
public struct CobblestonePattern: ProceduralPattern {
    public init() {}
...
public struct ConcretePattern: ProceduralPattern {
    public init() {}
...
public struct MetalPattern: ProceduralPattern {
    public init() {}
...
#if canImport(UIKit)
public func platformColor(from color: Color) -> UIColor {
    UIColor(color)
}

public func platformColorFromRGBA(_ r: CGFloat, _ g: CGFloat, _ b: CGFloat, _ a: CGFloat) -> UIColor {
    UIColor(red: r, green: g, blue: b, alpha: a)
}

extension UIColor {
    public func getRGBA(_ r: inout CGFloat, _ g: inout CGFloat, _ b: inout CGFloat, _ a: inout CGFloat) {
        getRed(&r, green: &g, blue: &b, alpha: &a)
    }
}
#elseif os(macOS)
public func platformColor(from color: Color) -> NSColor {
    NSColor(color)
}

public func platformColorFromRGBA(_ r: CGFloat, _ g: CGFloat, _ b: CGFloat, _ a: CGFloat) -> NSColor {
...
public struct ProceduralPatternFactory {
    ...
    public static func pattern(for fillType: BaseLayerFillType, metadata: TerrainMapMetadata? = nil) -> ProceduralPattern? {
